...
//+kubebuilder:rbac:groups=airship.kubekit.cloud,resources=airshipmachineproviderspecs;airshipmachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
