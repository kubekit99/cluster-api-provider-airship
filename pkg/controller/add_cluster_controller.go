...
//+kubebuilder:rbac:groups=airship.kubekit.cloud,resources=airshipclusterproviderspecs;airshipclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
