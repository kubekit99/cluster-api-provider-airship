...
func NewMachineScope(params MachineScopeParams) (*MachineScope, error) {
	scope, err := NewScope(ScopeParams{AirshipClients: params.AirshipClients, Client: params.Client, Cluster: params.Cluster})
	if err != nil {
		return nil, err
	}
...
type MachineScope struct {
	*Scope
	...
	MachineConfig *v1alpha1.AirshipMachineProviderSpec
	MachineStatus *v1alpha1.AirshipMachineProviderStatus
}
